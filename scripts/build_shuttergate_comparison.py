...
if reference_board.size != (1280, 360):
...
approved_keyframe = reference_board.crop((0, 0, 640, 360))
...
draw.text((760, 22), "ISSUE #287 RUNNING CLIENT · EXACT 1280×720 FRAME", fill="#f0bd67", font=font)
