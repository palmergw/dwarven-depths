...
Phase 5 currently includes six dependency-ordered vertical slices in `apps/web`:
...
- sprite assets, animation polish, camera controls, placement editing, target-policy and ability controls, health/cooldown details, upgrades, settings, respec, audio, or final visual design;
